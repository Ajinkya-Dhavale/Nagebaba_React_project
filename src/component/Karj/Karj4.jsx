                        ...
                        <div class="col-12 p-0">
                            <div class="back_img2" style={{ backgroundImage: " url ( " + " image/loan/back.jpg" + ")", height: "350px" }}>
                                <div class="inner_back">
                                    ...
                                    <h5 class="mt-2 pl-md-5 ml-5 font-weight-bold text-white">मुख्यपृष्ठ /  व्यावसायिक कर्ज</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="shadow-lg sona_div1 p-4 mt-5 bg-white rounded">
                                <h5 class="font-weight-bold mt-4">APPLY व्यावसायिक कर्ज</h5>
                        ...
                        <div class="col-md-8 col-12 p-4">
                            <h1 class="font-weight-bold mt-4">व्यावसायिक कर्ज</h1>
                            <p class="mt-5">दैनिक प्रतिनिधी मार्फत दररोज भरणा घेऊन कर्ज उपलब्ध करण्यात येते</p>
                            <img src="image/loan/c7.jpg" class="img-fluid rounded" style={{height:"400px"}} />
